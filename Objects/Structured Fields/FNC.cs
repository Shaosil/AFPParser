...
namespace AFPParser.StructuredFields
{
    public class FNC : StructuredField
    {
        ...
        private static List<Offset> _oSets = new List<Offset>()
        {
            ...
            new Offset(22, Lookups.DataTypes.CODE, "Shape Resolution X Unit Base") { Mappings = CommonMappings.AxisBase },
            new Offset(23, Lookups.DataTypes.CODE, "Shape Resolution Y Unit Base") { Mappings = CommonMappings.AxisBase },
